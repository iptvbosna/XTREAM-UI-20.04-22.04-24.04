...
rDownloadURL = {"main": "https://bitbucket.org/jalmina3/xtream-ui-20.04-22.04-24.04/raw/main/main_xui_sehara.zip", "sub": "https://bitbucket.org/jalmina3/xtream-ui-20.04-22.04-24.04/raw/main/sub_xui_sehara.zip"}
...
def install(rType="MAIN"):
    ...
    if os.path.exists("/tmp/xtreamcodes.zip"):
        ...
        if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/xtreamcodes"): 
            os.system("wget -q https://bitbucket.org/jalmina3/xtream-ui-20.04-22.04-24.04/raw/main/xtreamcodes -O /home/xtreamcodes/iptv_xtream_codes/xtreamcodes")
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = input('Example: https://bitbucket.org/jalmina3/xtream-ui-20.04-22.04-24.04/raw/main/release_22f.zip\n\nNow enter the link:\n\n')
    else:
        rlink = "https://bitbucket.org/jalmina3/xtream-ui-20.04-22.04-24.04/raw/main/release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://bitbucket.org/jalmina3/xtream-ui-20.04-22.04-24.04/raw/main/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://bitbucket.org/jalmina3/xtream-ui-20.04-22.04-24.04/raw/main/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
